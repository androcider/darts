...
class VideoService:
    ...
    def __init__(self, caption, width, height, cell_size, frame_rate, background, debug = False):
    ...
    def get_background(self):
        texture= pyray.load_texture(self._background)
    ...
    def draw_slider (self, actor):
        ...
        pyray.draw_rectangle(x, y, width, height, color,text,font_size)
    ...
    def _draw_score(self, x, y, score):
        pyray.draw_text(str(score), x,y, 25,pyray.WHITE)